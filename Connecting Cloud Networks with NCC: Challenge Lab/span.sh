...
echo "${CYAN_TEXT}${BOLD_TEXT}      CLOUD BY PRIYANK - INITIATING EXECUTION...  ${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}==================================================================${RESET_FORMAT}"
echo
...
echo "${CYAN_TEXT}${BOLD_TEXT}=======================================================${RESET_FORMAT}"
echo
echo "${RED_TEXT}${BOLD_TEXT}${UNDERLINE_TEXT}https://www.youtube.com/@cloudby-priyank${RESET_FORMAT}"
echo "${GREEN_TEXT}${BOLD_TEXT}Like, Share and Subscribe for more cloud tutorials${RESET_FORMAT}"
echo
